...
export const metadata: Metadata = {
  title: "NEO Books & Coffee - Hubli's Best Cafe",  description: "NEO Books and Coffee is Hubli's favorite cafe for specialty coffee, books, and a peaceful workspace. Perfect for remote workers, students, and book lovers.",  keywords: "cafe Hubli, coffee shop, book cafe, remote work, specialty coffee, cozy cafe, reading lounge",  metadataBase: new URL("https://neobooks.com"),
  alternates: {
    canonical: "https://neobooks.com"},
  openGraph: {
    title: "NEO Books & Coffee - Your Favorite Hubli Cafe",    description: "Discover NEO Books and Coffee - where great coffee meets great books. Perfect for working, reading, and relaxing.",    url: "https://neobooks.com",    siteName: "NEO Books & Coffee",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/woman-works-cafe-evening_1153-3549.jpg",        alt: "cafe interior coffee shop warm ambience cozy seating"},
    ],
    type: "website"},
  twitter: {
    card: "summary_large_image",    title: "NEO Books & Coffee",    description: "Hubli's favorite cafe for specialty coffee and books",    images: ["http://img.b2bpic.net/free-photo/woman-works-cafe-evening_1153-3549.jpg"],
  },
  robots: {
    index: true,
    follow: true,
